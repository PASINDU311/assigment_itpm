...
test.describe('Singlish to Sinhala - 24 Positive Functional Tests', () => {
    ...
    test('Pos_Fun_0003: Complex sentences (Long Text)', async ({ page }) => {
